...
$fb = new Facebook([
  'app_id' => '1515681238504516',
  'app_secret' => '2e53acd3d956c3043ad89f790aad2e88',
...
if (isset($accessToken)) {
    ...
    try {
		...
		if(isset($_POST['insert'])){
     	$data = ['source' => $fb->fileToUpload(__DIR__.'/photo.jpg'), 'message' => 'Check out this app! It is awesome http://localhost/fb/i.pnp '];
  ...
  $reasons = array(
  "you made out with this person's partner",
  "you ate this person's burger",
  "you insulted this person",
  "you did not go this person's party",
...
<form method="post"><center><input type="submit" name="insert" class="button" value=""/></center></form>
	...
	<h1 class="warning"><b><?php echo $name." is your previous birth country"; ?></b></h1>
